            ...
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="input-group">
                    ...
                    <div className="checkbox-group">
                        <div className="checkbox">
                            <input type="checkbox" id="interest1" name="interest1" value="Adventure" defaultChecked required />
                            <label htmlFor="interest1"> Adventure </label>
                        </div>
                        <div className="checkbox">
                            <input type="checkbox" id="interest2" name="interest2" value="Nature" required />
                            <label htmlFor="interest2"> Nature </label>
                        </div>
                        <div className="checkbox">
                            <input type="checkbox" id="interest3" name="interest3" value="Culture" required />
                            <label htmlFor="interest3"> Culture </label>
                        </div>
                        <div className="checkbox">
                            <input type="checkbox" id="interest4" name="interest4" value="Religious" required />
                ...
                <div className="input-group">
                    ...
                    <div className="radio-group">
                        ...
                        <div className="radio">
                            <input type="radio" id="medium" name="budget" value="Medium" required />
